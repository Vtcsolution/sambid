  ...
  try {
    ...
    const defaults = [
      { slug: 'contract-opportunities', title: 'Contract Opportunities', subtitle: 'Find federal contracts matched to your NAICS codes — auto-scored by AI', icon: 'FileText', color: 'indigo', order: 1,
        steps: [
          { title: 'Auto-matched to your NAICS', description: 'Every hour, Sambid pulls fresh postings directly from SAM.gov and checks each one against the NAICS codes you registered in your Company Profile. You never search manually — the moment a matching contract goes live, it\'s already sitting in your feed.' },
          { title: 'AI Match Score (0-100%)', description: 'Each opportunity gets scored on four things: how closely your NAICS codes fit, whether you qualify for the set-aside type, whether the contract value fits your typical range, and how well the agency aligns with your past work. A 90% score means it\'s worth your time; a 30% score means skip it.' },
          { title: 'Smart Filters', description: 'Narrow thousands of live postings down to a handful in seconds: due-date presets like "next 7 days," specific NAICS codes, notice type, agency, set-aside category, and contract value range — all combinable at once.' },
          { title: 'One-click detail', description: 'Click any card and get the complete picture on one page: full SAM.gov data, the AI\'s read on the opportunity, and direct links to every attached document — no jumping between five browser tabs.' },
        ],
      ...
      { slug: 'deadline-calendar', title: 'Deadline Calendar', subtitle: 'Never miss a submission deadline — color-coded by urgency', icon: 'CalendarDays', color: 'rose', order: 2,
        steps: [
          { title: 'All deadlines in one view', description: 'Every response deadline from your matched and saved opportunities lands on one shared monthly calendar automatically — no manual entry, no spreadsheet to maintain.' },
          { title: 'Color-coded urgency', description: 'At a glance you know exactly where you stand: red means 3 days or less, orange means a week, yellow means two weeks, green means you\'ve got time to breathe.' },
          { title: 'Calendar sync', description: 'Download an .ICS file and sync every deadline straight into Google Calendar, Outlook, or Apple Calendar, so it shows up right alongside the rest of your schedule — not buried in a separate app.' },
        ],
      ...
      { slug: 'ai-summarize', title: 'AI Summarize', subtitle: 'Full contract intelligence in seconds — powered by Claude AI with real SAM.gov data', icon: 'Sparkles', color: 'violet', order: 6,
        steps: [
          { title: 'Click "AI Summarize" on any opportunity', description: 'The AI reads the complete scope of work and description, up to 15,000 characters, so nothing important buried in dense government language gets missed.' },
          { title: 'Get structured analysis', description: 'What comes back is organized, not a wall of text: executive summary, scope of work, submission requirements, evaluation criteria, point of contact info, and any red flags worth knowing about before you commit.' },
          { title: 'Fit assessment', description: 'The AI checks the opportunity against your actual NAICS codes, certifications, and past wins, and gives you an honest read on whether this is genuinely a good fit for your company — not a generic "you could probably bid on this."' },
        ],
      ...
      { slug: 'bid-analysis', title: 'AI Bid Analysis', subtitle: 'Should you bid? Get a data-driven BID/NO-BID recommendation with real competitor intelligence', icon: 'Target', color: 'blue', order: 7,
        steps: [
          { title: 'AI fetches real competitors', description: 'Sambid pulls the 25 most recent contract awards from USASpending.gov in the same NAICS code, so you\'re not guessing who you\'re up against — you\'re looking at real companies with real award history.' },
          { title: 'Scoring matrix', description: 'Eight factors get rated 1-10 each: NAICS match, set-aside eligibility, past performance, competition level, pricing position, timeline fit, capacity, and agency relationship — giving you a transparent breakdown instead of a black-box number.' },
          { title: 'Win probability + bid range', description: 'Based on that scoring and the historical award data, you get a specific win percentage and a recommended price range — the same kind of analysis a $5,000 BD consultant would give you, generated in under a minute.' },
        ],
      ...
      { slug: 'proposal-builder', title: 'AI Proposal Builder', subtitle: 'Generate a complete 7-section government proposal using your real data', icon: 'FileEdit', color: 'indigo', order: 8,
        steps: [
          { title: 'Select opportunity', description: 'Choose from your saved contracts or enter one manually, and every piece of contract data auto-fills instantly — no retyping agency names, deadlines, or requirements.' },
          { title: 'AI generates 7 sections', description: 'A complete proposal draft comes back covering Cover Letter, Executive Summary, Technical Approach, Management Plan, Past Performance, Pricing Strategy, and Conclusion, referencing your real company data throughout — not filler text.' },
          { title: 'Export branded PDF', description: 'Pick from 6 professional color themes and download a submission-ready PDF — the kind of formatting that normally costs $5,000-$20,000 from a proposal writer.' },
        ],
      ...
      { slug: 'go-no-go', title: 'Go/No-Go Decision', subtitle: '10-factor scoring matrix — select an opportunity and get a data-driven bid decision', icon: 'ThumbsUp', color: 'green', order: 9,
        steps: [
          { title: 'Select from saved or feed', description: 'Pick any opportunity from your saved list or live feed, and every piece of data, including the full SOW text, loads automatically. No copy-pasting, no manual data entry.' },
          { title: 'AI analyzes 4 data sources', description: 'The engine cross-references the full SAM.gov contract, USASpending competitor history, your Company Profile, and your own past wins, all at once, to build a complete picture of your odds.' },
          { title: '10-factor scoring → GO/NO-GO', description: 'Each factor is scored 1-10 with the evidence behind it, rolled up into a total out of 100, and delivered as a clear GO or NO-GO call with a concrete action plan attached — not just a verdict, but what to do next.' },
        ],
