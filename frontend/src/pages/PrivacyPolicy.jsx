...
const sections = [
  ...
  },
  {
    ...
    body: `We do not sell your personal information to third parties. We may share your information with: (a) Service providers who assist us in operating the platform (cloud hosting, email delivery, payment processing, analytics) under strict data processing agreements; (b) Law enforcement or government bodies where required by law or to protect rights and safety; (c) Acquirers in the event of a merger, acquisition, or sale of assets, in which case you will be notified and given the opportunity to opt out; and (d) Other users only as required by features you have explicitly enabled (e.g., teaming partner finder shows your public business profile if you opt in).`,
  },
  {
  ...
  {
    title: '14. Contact Us',
    body: `For privacy-related questions, to exercise your rights, or to report a privacy concern, please contact our Privacy Team at: privacy@sambid.co or write to Sambid, Attn: Privacy, Arlington, VA 22203, USA. We will respond to all requests within 30 days.`,
  },
];
