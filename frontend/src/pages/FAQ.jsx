  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'We use verified SAM.gov data as the grounding source for all AI-generated content. The AI works from the actual RFP text you provide and does not invent facts about contracts. For proposals, it generates structure and language based on your input, not fabricated details.',
      },
    ],
  },
  {
